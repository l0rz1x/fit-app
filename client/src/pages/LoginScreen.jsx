      ...
      <div className="flex h-full min-h-screen grow flex-row">
        ...
        <div className="relative hidden w-1/2 flex-col items-center justify-center bg-cover bg-center lg:flex">
          ...
          <div 
            ...
            style={{ backgroundImage: "url('https://images.unsplash.com/photo-1540420773420-3366772f4999?q=80&w=2084&auto=format&fit=crop')" }} 
          ...
          <div className="flex w-full max-w-md flex-col gap-8 px-4 py-10">
            ...
            <div className="flex flex-col items-center gap-2 text-center">
              <div className="flex items-center gap-3">
                <span className="material-symbols-outlined text-primary text-4xl" style={{ fontVariationSettings: "'FILL' 1, 'wght' 500" }}>spa</span>
                <h1 className="text-xl font-bold text-text-light dark:text-text-dark">Akıllı Beslenme</h1>
              </div>
              <h2 className="text-4xl font-black leading-tight tracking-tight text-text-light dark:text-text-dark">Welcome Back</h2>
              <p className="text-subtle-light dark:text-subtle-dark">Ready to achieve your goals?</p>
            </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-4">
              ...
              <label className="flex flex-col w-full">
                <p className="text-base font-medium pb-2 text-text-light dark:text-text-dark">Email or Username</p>
              ...
              {/* Password Input */}
              <label className="flex flex-col w-full">
                <p className="text-base font-medium pb-2 text-text-light dark:text-text-dark">Password</p>
                <div className="flex w-full flex-1 items-stretch rounded-lg group focus-within:ring-2 focus-within:ring-primary/50 transition-shadow">
                  <div className="flex items-center justify-center pl-4 pr-2 border border-r-0 border-border-light dark:border-border-dark bg-input-bg-light dark:bg-input-bg-dark rounded-l-lg text-subtle-light dark:text-subtle-dark">
              ...
              <div className="flex flex-col gap-4 items-center mt-2">
                <button type="submit" className="flex w-full min-w-[84px] cursor-pointer items-center justify-center overflow-hidden rounded-lg h-12 px-5 bg-primary text-white text-base font-bold leading-normal tracking-[0.015em] hover:bg-green-600 transition-colors shadow-lg shadow-primary/20">
                  <span className="truncate">Log In</span>
                </button>
                <p className="text-sm font-normal leading-normal text-center text-subtle-light dark:text-subtle-dark">
                  Don't have an account? <a className="font-bold underline text-primary hover:text-orange-accent transition-colors" href="#">Sign Up</a>
                </p>
              </div>
            </form>
